...
#### Scenario: inventory reload does not undrain

- **WHEN** an operator has drained a `fleet.yaml` host and the router reloads permanent inventory in-process
- **THEN** the host stays drained and is still not selected for new work
