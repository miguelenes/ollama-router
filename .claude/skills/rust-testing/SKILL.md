...
Advanced patterns live in `reference/advanced-testing.md`: parameterized
tests (rstest) and fixtures, property-based testing (proptest), mocking
(mockall), doc tests, Criterion benchmarks, and coverage targets.
